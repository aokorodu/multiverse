      ...
      <div className={styles.introHolder}>
        ...
        <svg ref={stage} width={"100%"} height={"100%"} viewBox={`0 0 800 610`}>
          <g id="Intro">
            ...
            <g ref={addToScenes} id="scene_1" opacity={0}>
              <g id="observer">
                <g id="Ellipse 51">
            ...
            <g ref={addToScenes} id="scene_2a" opacity={0}>
            ...
            <g ref={addToScenes} id="scene_2b" opacity={0}>
              <g id="line_to_reflection" opacity="0.6">
                <line
                  id="Line 6"
                  x1="111.5"
            ...
            <g ref={addToScenes} id="scene_2c" opacity={0}>
              <g id="line_to_reflection" opacity="0.6">
                <line
                  id="Line 6"
                  x1="111.5"
              ...
              <g id="line_to_mirror">
                <path
                  id="Line 8"
                  d="M111.582 426.724L166 306"
                  stroke="#FF0000"
                />
                <path
                  id="Line 9"
                  d="M241.501 483.999L166 305"
                  stroke="#FF0000"
                />
              </g>
              <g id="shrunk_scene_1">
